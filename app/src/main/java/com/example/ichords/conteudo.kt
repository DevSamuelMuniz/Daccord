...
class MainActivity : AppCompatActivity() {
    ...
    private val imageResources = listOf(
        R.drawable.paleta_btn_um,
        R.drawable.paleta_btn_dois,
        R.drawable.paleta_btn_tres,
        R.drawable.paleta_btn_quatro,
        R.drawable.paleta_btn_cinco,
        R.drawable.paleta_btn_seis,
        R.drawable.paleta_btn_sete,
        R.drawable.paleta_btn_oito,
        R.drawable.paleta_btn_nove,
        R.drawable.paleta_btn_dez
    )
